...
export default function RecruiterInternships() {
  return (
      <div className='flex flex-col h-[600px] gap-y-3  border-blue rounded-lg'>
             ...
             <div className='bg-gray-200 rounded-lg w-full h-[10%]  flex items-center !px-5 gap-x-1'>
                 <div className='text-2xl font-bold uppercase w-1/2 bg-blue h-[100%] flex justify-start items-center gap-x-3'>
                  <span className=' text-slate-500'>0</span> <span className='text-blue-500'>Offres de Stage</span>
                </div>
             ...
             {/* application */}
             <div className='bg-gray-200 h-auto w-full flex flex-col gap-y-5 !p-5 rounded-lg border-1 border-gray-300 min-h-[200px]'>
                 {/* //offers */}
                    <div className='bg-white h-[200px] w-full flex flex-col  shadow-lg rounded-lg'>
                      <div className=' w-full h-auto flex !py-5 !px-3'>
                        <div  className='w-[62%] flex flex-col gap-y-2 '>
                          <Link class="text-lg font-bold capitalize hover:underline hover:text-blue-500" to={''}>developpeur</Link>
                          <div className='flex flex-col gap-y-3'>
                            {/*  */}
                            <div className='flex gap-x-4'>
                              <div className='flex gap-x-1'>
                                <MapPinIcon className='w-4 h-4 '/>
                                <div className='capitalize font-bold text-sm'>casablanca</div>
                              </div>
                               <div className='flex gap-x-1'>
                                ...
                                <div className='first-letter:capitalize text-sm'>sur site</div>
                              </div>
                              <div className='flex gap-x-1'>
                                <div className='flex items-center  gap-x-1'>
                                ...
                                <div className='flex items-center gap-x-1'><span className='first-letter:capitalize text-sm'>1</span> <span className='first-letter:capitalize text-sm'>stagaires</span></div>
                              </div>
                            </div>
                            {/*  */}
                            <div className='flex gap-x-2'>
                               <div className='flex gap-x-1'>
                                ...
                                <div className='first-letter:capitalize text-sm'>2025/06/155</div>
                              </div>
                               <div className='flex gap-x-1'>
                                <div className='flex items-center  gap-x-1'>
                                ...
                                <div className='first-letter:capitalize text-sm'>1-3 mois</div>
                              </div>
                              <div className='flex gap-x-1'>
                                <div className='flex items-center  gap-x-1'>
                                ...
                                <div className='text-sm first-letter:capitalize'>temps partiel</div>
                              </div>
                            </div>
                            ...
                            <div className='flex gap-x-4'>
                              ...
                              <div className='flex gap-x-1'>
                                ...
                                <div className='flex items-center gap-x-1'><span className='first-letter:capitalize text-sm'>03/06/2025</span></div>
                              </div>
                              <div className='flex items-center gap-x-1'>
                                <div className='flex items-center  gap-x-1'>
                                  <CalendarIcon className='w-4 h-4 text-slate-500'/>
                        ...
                        <div  className='bg-red w-[8%] flex flex-col gap-y-2 justify-center items-center'>
                          ...
                          <div className='first-letter:capitalize text-red-400 text-sm'>no publie</div>
                        </div>
                        <div  className='w-[30%]  flex flex-col items-center '>
                          <div className='w-[90%] '>
                            <div className='w-full grid grid-cols-4 gap-2 '>
                               <div className='col-span-2 bg-white border-2 border-gray-200 flex justify-center items-center gap-x-1 !p-3 rounded-lg  cursor-pointer w-full transition-all duration-100 hover:bg-gray-200'>
                                <PencilIcon className='w-4 h-4 text-black'/>
                                <div className='capitalize text-sm text-black'>modefier</div>
                              </div>
                               <div className='col-span-2 bg-blue-300  opacity-50  flex justify-center items-center gap-x-1 !p-3 rounded-lg  cursor-not-allowed w-full'>
                              <CheckCircleIcon className='w-5 h-5 text-white'/>
                              <div className='capitalize text-sm text-white'>publieé</div>
                              </div>
                      ...
                      <div className='bg-blue-100 w-full min-h-[21%] h-auto flex items-center !px-5 !py-2'>
                        <div className='w-fit first-letter:capitalize text-sm text-blue-300  bg-gray-100 rounded-lg flex gap-x-2 items-center !px-2 !py-1 '>
                    ...
                    {/* second offer */}
                     <div className='bg-white h-[200px] w-full flex flex-col  shadow-lg rounded-lg'>
                      <div className=' w-full h-auto flex !py-5 !px-3'>
                        <div  className='w-[62%] flex flex-col gap-y-2 '>
                          <Link class="text-lg font-bold capitalize hover:underline hover:text-blue-500" to={'/stage/titre-de-stage/'}>Stage Assitant(e) administratif(ive)</Link>
                          <div className='flex flex-col gap-y-3'>
                            {/*  */}
                            <div className='flex gap-x-4'>
                              <div className='flex gap-x-1'>
